...
public class Main extends Application {
    ...
    private HBox tokens = new HBox();
    private TableView<TokenType> tableView = new TableView<TokenType>();
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        TableColumn columnOne = new TableColumn("Type");
        TableColumn columnTwo = new TableColumn("Name");
        TableColumn columnThree = new TableColumn("Number");


        columnOne.setCellValueFactory(new PropertyValueFactory<TokenType, String>("Type"));
        columnTwo.setCellValueFactory(new PropertyValueFactory<TokenType, String>("Name"));
        columnThree.setCellValueFactory(new PropertyValueFactory<TokenType, Integer>("Number"));
                    ...
                    switch (actionItem.getText()){
                        case "Compile":{
                            ...
                            for(Token token:tokens.getTokens()){
                                //TOKENS
                                tokenTypes.add(new TokenType(CPP14Lexer.VOCABULARY.getSymbolicName(token.getType()), token.getText(), token.getType()));
                                //AAAAAAAAAAA
                                //BBBBBBBBB

                                System.out.println(CPP14Lexer.VOCABULARY.getSymbolicName(token.getType())+" "+token.getText());
                            }
                            tableView.getItems().setAll(tokenTypes);
